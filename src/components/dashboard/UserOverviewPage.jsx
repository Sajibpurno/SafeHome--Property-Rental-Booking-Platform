          ...
          {recentBookings.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
              {recentBookings.map((b) => (
                <div key={b._id} className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition">
                  <img
                    src={b.propertyImage}
                    alt={b.propertyTitle}
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-800 truncate">{b.propertyTitle}</p>
