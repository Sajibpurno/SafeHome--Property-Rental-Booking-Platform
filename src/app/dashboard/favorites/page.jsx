...
const FavoritesPage = () => {
  ...
  if (loading) return <p className="text-gray-400 text-sm">Loading favorites...</p>;
        ...
        <div className="overflow-x-auto rounded-xl border border-gray-200">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {favorites.map((fav) => (
                <tr key={fav._id} className="hover:bg-gray-50 transition">
                  ...
                  <td className="px-5 py-4 font-semibold text-gray-800">
                    ...
                    <span className="text-xs text-gray-400 font-normal ml-1">/{fav.rentType}</span>
                  </td>
                  <td className="px-5 py-4">
                    <button
